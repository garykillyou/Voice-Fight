...
public class UnknownMan1Controller : MonoBehaviour {
        ...
        if (GameFunction.Instance.IsPlaying && block)
        {
            ...
            {      //**********************************  面相右  ********************************************
                ...
                else if (Input.GetKeyDown(KeyCode.F)) // -----------------------------------------------
                {
                    ...
                    Instantiate(darkskill, GameFunction.Instance.pos1 + new Vector3(20f, 0, 0), gameObject.transform.rotation);
                ...
                else if (Input.GetKeyDown(KeyCode.G)) // ------------------------------------------------
                {
                    ...
                    block = false;
                    GameFunction.Instance.p1hit = true;  //  通知 gamefuntion p1 在攻擊
                    Instantiate(darkskill, GameFunction.Instance.pos1 + new Vector3(70f, 0, 0), gameObject.transform.rotation);
                }
                else if (Input.GetKeyDown(KeyCode.H)) // ---------------------------------------------
                {
                    ...
                    block = false;
                    GameFunction.Instance.p1hit = true;  //  通知 gamefuntion p1 在攻擊
                    Instantiate(darkskill, GameFunction.Instance.pos1 + new Vector3(120f, 0, 0), gameObject.transform.rotation);
                }
            ...
            if (rightface)
            {
                ...
                if (animatorInfo.IsName("hitR2"))
                {
                    ...
                    if (Input.GetKeyDown(KeyCode.F) && !hiting)
                    {
                        ...
                        Instantiate(darkbomb, GameFunction.Instance.pos1 + new Vector3(20f, 0, 0), gameObject.transform.rotation);
                        if (GameFunction.Instance.pos1.x + 20f > GameFunction.Instance.pos2.x - 15f &&
                            GameFunction.Instance.pos1.x + 20f < GameFunction.Instance.pos2.x + 15f)
                        {
                    ...
                    else if (Input.GetKeyDown(KeyCode.G) && !hiting)
                    {
                        ...
                        playerAnimator.Rebind();
                        playerAnimator.Play("hitR2");
                        Instantiate(darkbomb, GameFunction.Instance.pos1 + new Vector3(70f, 0, 0), gameObject.transform.rotation);
                        if (GameFunction.Instance.pos1.x + 70f > GameFunction.Instance.pos2.x - 15f &&
                            GameFunction.Instance.pos1.x + 70f < GameFunction.Instance.pos2.x + 15f)
                        {
                            if (GameFunction.Instance.pos1.y > GameFunction.Instance.pos2.y - 20f &&
                                GameFunction.Instance.pos1.y < GameFunction.Instance.pos2.y + 20f)  //再次確認y軸  高度
                                GameFunction.Instance.p2hited = true;
                    ...
                    else if (Input.GetKeyDown(KeyCode.H) && !hiting)
                    {
                        ...
                        playerAnimator.Rebind();
                        playerAnimator.Play("hitR2");
                        Instantiate(darkbomb, GameFunction.Instance.pos1 + new Vector3(120f, 0, 0), gameObject.transform.rotation);
                        if (GameFunction.Instance.pos1.x + 120f > GameFunction.Instance.pos2.x - 15f &&
                            GameFunction.Instance.pos1.x + 120f < GameFunction.Instance.pos2.x + 15f)
                        {
                            if (GameFunction.Instance.pos1.y > GameFunction.Instance.pos2.y - 20f &&
                                GameFunction.Instance.pos1.y < GameFunction.Instance.pos2.y + 20f)  //再次確認y軸  高度
                                GameFunction.Instance.p2hited = true;
                    ...
                    else if (hiting && hittime == 2)
                    {
						...
						if (Input.GetKeyDown(KeyCode.F))
                        {
                            ...
                            playerAnimator.Rebind();
                            playerAnimator.Play("hitR2");
                            Instantiate(darkend, GameFunction.Instance.pos1 + new Vector3(20f, 0, 0), gameObject.transform.rotation);
                            if (GameFunction.Instance.pos1.x + 20f > GameFunction.Instance.pos2.x - 20f &&
                                GameFunction.Instance.pos1.x + 20f < GameFunction.Instance.pos2.x + 20f)
                            {
                                if (GameFunction.Instance.pos1.y > GameFunction.Instance.pos2.y - 20f &&
                                    GameFunction.Instance.pos1.y < GameFunction.Instance.pos2.y + 20f)  //再次確認y軸  高度
                        ...
                        else if (Input.GetKeyDown(KeyCode.G))
                        {
                            ...
                            playerAnimator.Rebind();
                            playerAnimator.Play("hitR2");
                            Instantiate(darkend, GameFunction.Instance.pos1 + new Vector3(70f, 0, 0), gameObject.transform.rotation);
                            if (GameFunction.Instance.pos1.x + 70f > GameFunction.Instance.pos2.x - 20f &&
                                GameFunction.Instance.pos1.x + 70f < GameFunction.Instance.pos2.x + 20f)
                            {
                                if (GameFunction.Instance.pos1.y > GameFunction.Instance.pos2.y - 20f &&
                                    GameFunction.Instance.pos1.y < GameFunction.Instance.pos2.y + 20f)  //再次確認y軸  高度
                                    GameFunction.Instance.p2hitended = true;
                        ...
                        else if (Input.GetKeyDown(KeyCode.H))
                        {
                            ...
                            playerAnimator.Rebind();
                            playerAnimator.Play("hitR2");
                            Instantiate(darkend, GameFunction.Instance.pos1 + new Vector3(120f, 0, 0), gameObject.transform.rotation);
                            if (GameFunction.Instance.pos1.x + 120f > GameFunction.Instance.pos2.x - 20f &&
                                GameFunction.Instance.pos1.x + 120f < GameFunction.Instance.pos2.x + 20f)
                            {
                                if (GameFunction.Instance.pos1.y > GameFunction.Instance.pos2.y - 20f &&
                                    GameFunction.Instance.pos1.y < GameFunction.Instance.pos2.y + 20f)  //再次確認y軸  高度
                                    GameFunction.Instance.p2hitended = true;
